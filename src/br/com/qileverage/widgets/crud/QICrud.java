...
public abstract class QICrud<ENTIDADE extends Entidade> extends QIPilhaVertical implements QITela
{
	...
	public void adicionarColuna(Column<ENTIDADE, ?> coluna, String nomeColuna, HorizontalAlignmentConstant horizontalAlignment)
	{
		this.adicionarColuna(coluna, nomeColuna);
		this.setHorizotalAlignmentColuna(coluna, horizontalAlignment);
	}
	
	public void adicionarColuna(Column<ENTIDADE, ?> coluna, String nomeColuna, String columnWidth)
	{
		this.adicionarColuna(coluna, nomeColuna);
		this.setWidthColuna(coluna, columnWidth);
	}
	
	public void adicionarColuna(Column<ENTIDADE, ?> coluna, String nomeColuna, String columnWidth, HorizontalAlignmentConstant horizontalAlignment)
	{
		this.adicionarColuna(coluna, nomeColuna);
		this.setHorizotalAlignmentColuna(coluna, horizontalAlignment);
		this.setWidthColuna(coluna, columnWidth);
