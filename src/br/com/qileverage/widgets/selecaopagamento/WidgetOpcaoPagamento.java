...
public class WidgetOpcaoPagamento extends QIPilhaVertical implements QITela, HasClickHandlers
{
	...
	public WidgetOpcaoPagamento(QIInterfaceTipoPagamento opcaoPagamento)
	{
	...
	public void adicionarEstiloSelecao()
	{
		this.addStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_selecionado());
		lblNomeOpcaoPagamento.addStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_labelnome_selecionado());
		imgOpacaoPagamento.addStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_imagem_selecionado());
		// rbClicavel.addStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_radiobuttonselecao_selecionado());
		// qiPilhaVerticalpainelGrafico.addStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_painelconteudografico_selecionado());
	}

	public void removerEstiloSelecao()
	{
		this.removeStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_selecionado());
		lblNomeOpcaoPagamento.removeStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_labelnome_selecionado());
		imgOpacaoPagamento.removeStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_imagem_selecionado());
		// rbClicavel.removeStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_radiobuttonselecao_selecionado());
		// qiPilhaVerticalpainelGrafico.removeStyleName(Resources.INSTANCE.cssQiLeverageWidgets().widget_selecaopagamento_painelselecaopagamento_opcaopagamento_painelconteudografico_selecionado());
	}
